...
export class EKycInfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const ekycUserPoolClient = new cognito.UserPoolClient(
      this,
      "ekyc-cognito-user-pool-client",
      {
    ...
    // API route handler
    const eKycApiCreateRequestHandler = new NodejsFunction(
      this,
      "eKyc-api-create-request-handler",
      {
    ...
    const eKycApiGetRequestStatusHandler = new NodejsFunction(
      this,
      "eKyc-api-get-request-status-handler",
      {
    ...
    const eKycSfnValidateRequestHandler = new NodejsFunction(
      this,
      "eKyc-sfn-validate-request-handler",
      {
    ...
    const eKycSfnFacialMatchHandler = new NodejsFunction(
      this,
      "eKyc-sfn-facial-match-handler",
      {
    ...
    const eKycSfnTextExtractionHandler = new NodejsFunction(
      this,
      "eKyc-sfn-text-extraction-handler",
      {
    ...
    const eKycSfnExternalIdValidationHandler = new NodejsFunction(
      this,
      "eKyc-sfn-ext-validation-handler",
      {
    ...
    const eKycSfnMarkSuccessHandler = new NodejsFunction(
      this,
      "eKyc-sfn-mark-success-handler",
      {
    ...
    const eKycSfnMarkFailedHandler = new NodejsFunction(
      this,
      "eKyc-sfn-mark-failed-handler",
      {
    ...
    const sfnSuccess = new stepFunction.Succeed(
      this,
      "eKyc-state-machine-succeed",
      {
    ...
    const sfnExternalIdValidationTask = new tasks.LambdaInvoke(
      this,
      "sfn-external-id-validation-request",
      {
    ...
    const sfnExternalValidationDefinition = sfnExternalIdValidationTask.next(
      new stepFunction.Choice(this, "Document Valid?")
        .when(
          stepFunction.Condition.booleanEquals("$.Payload.validDocument", true),
          sfnSuccessTask
        )
        .otherwise(sfnFailureTask)
    );

    const sfnTextExtractionTask = new tasks.LambdaInvoke(
      this,
      "sfn-text-extraction-request",
      {
    ...
    const sfnTextExtractionDefinition = sfnTextExtractionTask.next(
      new stepFunction.Choice(this, "Details Extractable?")
        .when(
          stepFunction.Condition.booleanEquals("$.Payload.success", true),
          sfnExternalValidationDefinition
        )
        .otherwise(sfnFailureTask)
    );

    const sfnFacialMatchTask = new tasks.LambdaInvoke(
      this,
      "sfn-facial-match-request",
      {
    ...
    const sfnFacialMatchDefinition = sfnFacialMatchTask.next(
      new stepFunction.Choice(this, "Face Matches?")
        .when(
          stepFunction.Condition.booleanEquals("$.Payload.match", true),
          sfnTextExtractionDefinition
        )
        .otherwise(sfnFailureTask)
    );

    const sfnValidationTask = new tasks.LambdaInvoke(
      this,
      "sfn-validate-request",
      {
    ...
    const sfnValidationDefinition = sfnValidationTask.next(
      new stepFunction.Choice(this, "Is Valid?")
        .when(
          stepFunction.Condition.booleanEquals("$.Payload.valid", true),
          sfnFacialMatchDefinition
        )
        .otherwise(sfnFailureTask)
    );

    const eKycStateMachine = new stepFunction.StateMachine(
      this,
      "eKyc-state-machine",
      {
    ...
    const eKycSqsTriggerStepFunctionHandler = new NodejsFunction(
      this,
      "eKyc-sqs-trigger-step-function-handler",
      {
