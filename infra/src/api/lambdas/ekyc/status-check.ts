...
export const handler = async (
    ...
    const request_id = event.queryStringParameters ? event.queryStringParameters.request_id : undefined;
    ...
    try {
        ...
        const requestDetails: EKycRequestStatusDTO = {
            ...
            date_of_birth: item.Item.date_of_birth && item.Item.date_of_birth.S ? item.Item.date_of_birth.S : '',
            id_number: item.Item.id_number && item.Item.id_number.S ? item.Item.id_number.S : '',
            s3_bucket: item.Item.s3_bucket && item.Item.s3_bucket.S ? item.Item.s3_bucket.S : '',
            id_type: item.Item.id_type && item.Item.id_type.S ? item.Item.id_type.S : '',
            id_front: item.Item.id_front && item.Item.id_front.S ? item.Item.id_front.S : '',
            selfie: item.Item.selfie && item.Item.selfie.S ? item.Item.selfie.S : '',
            creation_time: item.Item.creation_time && item.Item.creation_time.N ? parseInt(item.Item.creation_time.N) : 0,
            update_time: item.Item.update_time && item.Item.update_time.N ? parseInt(item.Item.update_time.N) : 0,
            complete: item.Item.complete && item.Item.complete.BOOL ? item.Item.complete.BOOL : false,
        }
